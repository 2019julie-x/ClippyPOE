 ...
 *
 * OverlayController manages the two overlay states:
 *   - interactive   : overlay captures mouse/keyboard
 *   - clickthrough  : input passes through to the game
 *
 * It also calculates effective opacity and sends it to the renderer.
 */
...
/**
 * Create a mock BrowserWindow with jest spy functions.
 */
